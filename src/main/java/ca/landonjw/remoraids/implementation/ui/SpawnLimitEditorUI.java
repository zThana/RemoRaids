 ...
 * @since  1.0.0
 */
public class SpawnLimitEditorUI extends BaseBossUI {
     ...
     */
    public SpawnLimitEditorUI(@Nonnull EntityPlayerMP player, @Nonnull IBossEntity bossEntity) {
    ...
    public void open() {
        ...
        if(TimedSpawnListener.getInstance().getTimedBossSpawner(bossEntity).isPresent()){
            ...
            templateBuilder = templateBuilder
                    .set(2, 2, decrementSpawns)
                    .set(2, 4, spawnAmount)
                    .set(2, 6, incrementSpawns);
        }
        else{
            Button spawnAmount = Button.builder()
                    .item(new ItemStack(Items.PAPER))
