    ...
    class Editor extends BaseBossUI {
        ...
        public void open() {
            ...
            timeValueBuilder = timeValueBuilder
                    .displayName(TextFormatting.AQUA + "" + TextFormatting.BOLD + "Cooldown Time: " + restraint.getCooldown(validTimeUnits[currentTimeUnitOrdinal]));
            ...
            Page page = Page.builder()
                    .template(template)
                    .title(TextFormatting.BLUE + "" + TextFormatting.BOLD + "Edit Cooldown Restraint")
                    .build();
