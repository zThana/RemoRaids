...
public interface Button {
	 ...
	 *
	 * <p>
	 * Most buttons should be of type Standard.
	 ...
	 * with the {@link Page#getTotalPages()} and {@link Page#getPageNumber()} respectively.
	 * </p>
	 *
	...
	static Button of(@Nonnull ItemStack item) {
		return InventoryAPI.getInstance().buttonBuilder().item(item).build();
	}
