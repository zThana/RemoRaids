...
public class BaseButton implements Button {
	 ...
	 */
	protected BaseButton(@Nonnull ItemStack item, @Nullable String displayName, @Nullable List<String> lore, @Nonnull ButtonType type, @Nullable Consumer<ButtonAction> behavior) {
