 ...
 *
 * <p>
 * This contains the overall layout of a page, and allows for the addition
 * of {@link Button}s to make a page interactive.
 * </p>
 *
 * @author landonjw
 * @since 1.0.0
...
public interface Template {
	 ...
	 *
	 * <p>
	 * The buttons are contained within a two dimensional array corresponding
	 * to the rows and columns on the template. Any row or column that does not
	 * have a button will be null.
	 * </p>
	 *
	...
	interface Builder {
		 ...
		 * Sets a button at a position on the template.
		 *
		 * @param index  the index to set button in
		 * @param button the button to set, null to remove any existing button at location
		 * @return builder with button set
		 */
		Builder set(int index, @Nullable Button button);
		 ...
		 *
		 * <p>
		 * If the line length will go over the page bounds, the line will stop.
		 * If line type is vertical, it will draw from top to bottom.
		 * If line type is horizontal, it will draw from left to right.
		 * </p>
		 *
